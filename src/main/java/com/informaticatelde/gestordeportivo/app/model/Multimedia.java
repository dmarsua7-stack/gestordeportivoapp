...
public class Multimedia {
    ...
    public Multimedia (String nombre, String descripcion, Integer jugador_id,
                       Integer instalacion_id, Integer ejercicio_id, Integer entrenamiento_id,
                        Integer equipo_id, Integer evento_id) {
